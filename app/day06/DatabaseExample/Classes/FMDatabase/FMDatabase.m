...
/*- (NSString *) getDatabaseFullPath{
	...
	NSString *path = [documentsDirectory stringByAppendingPathComponent:@"scb.sqlite"];
	return path;
}*/
...
- (void) copyDatabaseIfNeeded{
    ...
    if(!success) {
        ...
        NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"scb.sqlite"];
